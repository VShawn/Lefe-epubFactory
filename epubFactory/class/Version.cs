...
namespace epubFactory
{
    static class Version
    {
        ...
        public const string edition = "LeFe 0.0.2";
        public const int date = 20141207;            //当前版本时间
        public const string sofeId = "LeFe PROJECT";      //标识符
        public const string versionXml = "http://singlex.sinaapp.com/LeFe/version.php";
